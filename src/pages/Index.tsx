...
const testimonials = [
  {
    quote:
      "Working with Abbtec on the design of my 8-bedroom maisonette in Bungoma was a seamless experience. Their team didn't just draw a house, they engineered a masterpiece. The attention to structural integrity and aesthetic flow actually exceeded my expectations. I am thoroughly impressed by the quality of work delivered and look forward to the construction phase with full confidence in their excellence. If you want to actualize your dream project, Abbtec is the firm to call.",
    name: "Israel Tali",
    title: "Founder & MD, Tali Tali Advocates",
  },
  {
    quote:
      "For my residential project in Kitui, I needed a contractor who understood both engineering excellence and cost-efficiency. Abbtec delivered on both. Their team is disciplined, their structural work is impeccable, and they communicate every step of the way. Managing a construction project from a distance can be stressful, but their professionalism and constant site supervision gave me complete peace of mind. The result is a stunning, sturdy maisonette that exceeds all my expectations. I highly recommend them for any serious building project in Kenya.",
    name: "Makau Jackton",
    title: "MD, Klaus Fuchs Investment",
  },
];
...
const Index = () => (
  <Layout>
    ...
    <section className="relative min-h-[70vh] flex items-center">
      ...
      <div className="relative container-custom px-4 py-20">
        <div className="max-w-xl animate-fade-in-up">
          <p className="text-primary font-semibold text-base uppercase tracking-widest mb-3">
          ...
          <p className="text-secondary/80 text-lg sm:text-xl mb-8 leading-relaxed">
            From residential &amp; commercial buildings to roadworks and water systems — Abbtec delivers quality civil engineering solutions across Kenya.
          </p>
          <div className="flex flex-wrap gap-3">
            ...
            <Button asChild variant="outline" size="lg" className="border-secondary/30 text-primary hover:bg-secondary/10">
    ...
    <section className="bg-primary">
      <div className="container-custom px-4 py-10 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
        {stats.map((s) => (
          <div key={s.label}>
            <p className="font-display text-2xl sm:text-3xl font-bold text-primary-foreground">{s.value}</p>
            <p className="text-primary-foreground/70 text-sm sm:text-base mt-1">{s.label}</p>
          </div>
        ))}
      </div>
    </section>
    ...
    <section className="section-padding bg-section-alt">
      <div className="container-custom">
        <div className="text-center mb-12">
          <p className="text-primary font-semibold text-base uppercase tracking-widest mb-2">What We Do</p>
    ...
    <section className="section-padding">
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-primary font-semibold text-base uppercase tracking-widest mb-2">Why Abbtec</p>
    ...
    <section className="section-padding bg-section-alt">
      <div className="container-custom">
        <div className="text-center mb-12">
          <p className="text-primary font-semibold text-base uppercase tracking-widest mb-2">Testimonials</p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {testimonials.map((t) => (
            ...
            >
              <Quote size={36} className="text-primary/15 absolute top-6 right-6" />
