  ...
  <Layout>
    ...
    <section className="section-padding">
      <div className="container-custom max-w-3xl">
        ...
        <p className="text-muted-foreground text-base mb-8">Last updated: February 2026</p>

        <div className="space-y-6 text-base text-muted-foreground leading-relaxed">
          <div>
            <h2 className="font-display text-xl font-semibold text-foreground mb-2">Use of Website</h2>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold text-foreground mb-2">Services</h2>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold text-foreground mb-2">Intellectual Property</h2>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold text-foreground mb-2">Limitation of Liability</h2>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold text-foreground mb-2">Contact</h2>
