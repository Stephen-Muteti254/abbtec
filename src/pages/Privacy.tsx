    ...
    <section className="section-padding">
      <div className="container-custom max-w-3xl">
        ...
        <div className="space-y-6 text-base text-muted-foreground leading-relaxed">
          ...
          <div>
            <h2 className="font-display text-xl font-semibold text-foreground mb-2">How We Use Your Information</h2>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold text-foreground mb-2">Data Security</h2>
